            ...
            <div className="card-body">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  />
                  {errors.mileage && (
                    <p className="form-error">{errors.mileage.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.bodyType && (
                    <p className="form-error">{errors.bodyType.message}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  {errors.transmission && (
                    <p className="form-error">{errors.transmission.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.engineSize && (
                    <p className="form-error">{errors.engineSize.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.doors && (
                    <p className="form-error">{errors.doors.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.cylinders && (
                    <p className="form-error">{errors.cylinders.message}</p>
                  )}
                </div>
              </div>
            </div>
