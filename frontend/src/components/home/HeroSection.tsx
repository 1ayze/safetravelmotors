...
const HeroSection: React.FC<HeroSectionProps> = ({ onWatchVideo }) => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link
                to="/cars"
                className="btn bg-white text-black hover:bg-gray-100 focus:ring-white btn-lg"
              >
                Browse Cars
              ...
              <button
                ...
                className="btn btn-outline border-white text-gray-700 bg-white hover:bg-gray-100 hover:text-primary-600 btn-lg"
              >
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <div className="aspect-video bg-gradient-to-br from-white/20 to-white/5 rounded-xl overflow-hidden">
                  <img
                    src="/kia solento.webp"
                    alt="Kia Sorento - Premium SUV"
